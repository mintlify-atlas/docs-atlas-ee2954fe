...
description: "Mundial de Clicks is a real-time click-voting app built with Astro SSR and DragonFly. One Lua script, one poller, zero per-viewer cost."
---
...
| Layer | Technology |
|---|---|
| Framework | Astro 7 — `output: 'server'` with `@astrojs/node` standalone adapter |
