...
description: "GET /api/stream delivers live WorldSnapshot updates via SSE. One serialization per tick is fanned out to all subscribers — viewer count does not increase DragonFly load."
---
