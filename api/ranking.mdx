...
description: "GET /api/ranking returns the current WorldSnapshot from in-memory state, including the full ranking, total votes, clicks per minute, and recent live events."
---
...
<ResponseField name="events" type="LiveEvent[]">
  Recent live events broadcast to all clients — overtakes, round-number milestones, and leadership changes. The array is ordered chronologically.
  ...
  <Expandable title="LiveEvent fields">
    ...
    <ResponseField name="type" type="string">
      ...
      - `"milestone"` — a country crossed a round-number vote threshold
    ...
    <ResponseField name="code" type="string">
      Country code of the event's protagonist. Present for `"overtake"`, `"milestone"`, and `"leader"` events; may be omitted for global events.
    </ResponseField>
