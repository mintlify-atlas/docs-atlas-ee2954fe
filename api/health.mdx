---
title: "GET /api/health — Node.js Process Liveness Probe"
sidebarTitle: "GET /health"
description: "GET /api/health returns plain-text 200 OK confirming the Node.js process is alive. No external dependencies checked. Polled by Coolify and Traefik."
---
