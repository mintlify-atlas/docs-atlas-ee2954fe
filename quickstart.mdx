...
description: "Run Mundial de Clicks on your machine in three commands. Requires Node >= 22, pnpm, and Docker. No environment variables needed for local development."
---
